...
bool RendererState::hasImage(UpdateParameters& updateParameters, std::string id) {
...
bool RendererState::hasLayer(UpdateParameters& updateParameters, std::string id) {
...
bool RendererState::hasSource(UpdateParameters& updateParameters, std::string id) {
